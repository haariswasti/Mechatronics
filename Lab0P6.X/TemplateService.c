...
ES_Event RunTemplateService(ES_Event ThisEvent)
{
    ...
    case ES_INIT:
        ...
        printf("ROACH Events working \r\n");
        break;
        
    case INTO_LIGHT:
        printf("Roach in Light param = %d\r\n", ThisEvent.EventParam);
        break;
    
    case INTO_DARK:
        printf("Roach in dark param = %d\r\n", ThisEvent.EventParam);
        break;
    
    case BUMPER_PRESSED:
        printf("Roach Hit bumper param = %d\r\n", ThisEvent.EventParam);
        break;
        
            
   case BUMPER_RELEASED:       
       printf("Roach bumper let go param = %d\r\n", ThisEvent.EventParam);
       break;
